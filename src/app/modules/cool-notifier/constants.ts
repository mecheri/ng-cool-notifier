...
export const DEFAULT_ICONS: IIcons = {
    alert: `
          <svg class="cool-notification-svg" xmlns="http://www.w3.org/2000/svg" fill="#ffffff" height="24" viewBox="0 0 24 24" width="24">
    ...
    success: `
      ...
      `,
    warn: `
          <svg class="cool-notification-svg" xmlns="http://www.w3.org/2000/svg" fill="#ffffff" width="64" viewBox="0 0 64 64" height="64">
